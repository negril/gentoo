...
src_test() {
	...
	local CMAKE_SKIP_TESTS=(
		...
		# RunCMake.CPack_RPM: breaks if app-arch/rpm is installed because debugedit binary is not in the expected location
		# RunCMake.CPack_DEB: breaks if app-arch/dpkg is installed because it can't find a deb package that owns libc
		"RunCMake.CPack_(DEB|RPM)"
