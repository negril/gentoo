...
SRC_URI="https://github.com/qtproject/pyside-pyside-setup/archive/refs/tags/v${PV}.tar.gz -> ${MY_PN}-${PV}.gh.tar.gz"
S="${WORKDIR}/pyside-pyside-setup-${PV}/sources/pyside-tools"
