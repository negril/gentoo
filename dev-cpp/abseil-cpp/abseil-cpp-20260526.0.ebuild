...
SRC_URI="
	...
	https://github.com/abseil/abseil-cpp/commit/d851fdd768b27c02b3fb786fd0987faddd279ece.patch
		-> ${PN}-20260526.0-include-immintrin.patch
"
...
PATCHES=(
	...
	"${DISTDIR}/${PN}-20260526.0-include-immintrin.patch"
)
