...
SLOT="0/51.$(ver_rs 1-2 '' "$(ver_cut 1-2)")"
...
src_prepare() {
	...
	if use test; then
		...
		ln -rs "${WORKDIR}/data-plane-api-${ENVOY_API_COMMIT}" third_party/envoy-api || die
		rmdir third_party/googleapis || die
		ln -rs "${WORKDIR}/googleapis-${GOOGLEAPIS_COMMIT}" third_party/googleapis || die
		rmdir third_party/xds || die
		ln -rs "${WORKDIR}/xds-${XDS_COMMIT}" third_party/xds || die
		rmdir third_party/protoc-gen-validate || die
		ln -rs "${WORKDIR}/protoc-gen-validate-${PROTOC_GEN_VALIDATE_COMMIT}" third_party/protoc-gen-validate || die
...
src_test() {
	...
	local GTEST_SKIP_TESTS=(
		...
		#
		"XdsTest/RlsTest.XdsRoutingClusterSpecifierPlugin/V3*"
		"XdsTest/RlsTest.XdsRoutingClusterSpecifierPlugin/V3Rds*"
		"XdsTest/RlsTest.XdsRoutingClusterSpecifierPluginDisabled/V3*"
		"XdsTest/RlsTest.XdsRoutingClusterSpecifierPluginDisabled/V3Rds*"

		#
		"XdsTest/ClientStatusDiscoveryServiceTest.XdsConfigDumpVanilla/V3BootstrapFromEnvVar*"
		"XdsTest/ClientStatusDiscoveryServiceTest.XdsConfigDumpVanilla/V3RdsBootstrapFromEnvVar*"
		"XdsTest/ClientStatusDiscoveryServiceTest.XdsConfigDumpVanilla/V3CsdsStreamingBootstrapFromEnvVar*"
		"XdsTest/ClientStatusDiscoveryServiceTest.XdsConfigDumpVanilla/V3RdsCsdsStreamingBootstrapFromEnvVar*"
		"XdsTest/ClientStatusDiscoveryServiceTest.XdsConfigDumpListenerError/V3BootstrapFromEnvVar*"
		"XdsTest/ClientStatusDiscoveryServiceTest.XdsConfigDumpListenerError/V3RdsBootstrapFromEnvVar*"
		"XdsTest/ClientStatusDiscoveryServiceTest.XdsConfigDumpListenerError/V3CsdsStreamingBootstrapFromEnvVar*"
		"XdsTest/ClientStatusDiscoveryServiceTest.XdsConfigDumpListenerError/V3RdsCsdsStreamingBootstrapFromEnvVar*"
		"XdsTest/ClientStatusDiscoveryServiceTest.XdsConfigDumpRouteError/V3BootstrapFromEnvVar*"
		"XdsTest/ClientStatusDiscoveryServiceTest.XdsConfigDumpRouteError/V3RdsBootstrapFromEnvVar*"
		"XdsTest/ClientStatusDiscoveryServiceTest.XdsConfigDumpRouteError/V3CsdsStreamingBootstrapFromEnvVar*"
		"XdsTest/ClientStatusDiscoveryServiceTest.XdsConfigDumpRouteError/V3RdsCsdsStreamingBootstrapFromEnvVar*"
		"XdsTest/ClientStatusDiscoveryServiceTest.XdsConfigDumpClusterError/V3BootstrapFromEnvVar*"
		"XdsTest/ClientStatusDiscoveryServiceTest.XdsConfigDumpClusterError/V3RdsBootstrapFromEnvVar*"
		"XdsTest/ClientStatusDiscoveryServiceTest.XdsConfigDumpClusterError/V3CsdsStreamingBootstrapFromEnvVar*"
		"XdsTest/ClientStatusDiscoveryServiceTest.XdsConfigDumpClusterError/V3RdsCsdsStreamingBootstrapFromEnvVar*"
		"XdsTest/ClientStatusDiscoveryServiceTest.XdsConfigDumpEndpointError/V3BootstrapFromEnvVar*"
		"XdsTest/ClientStatusDiscoveryServiceTest.XdsConfigDumpEndpointError/V3RdsBootstrapFromEnvVar*"
		"XdsTest/ClientStatusDiscoveryServiceTest.XdsConfigDumpEndpointError/V3CsdsStreamingBootstrapFromEnvVar*"
		"XdsTest/ClientStatusDiscoveryServiceTest.XdsConfigDumpEndpointError/V3RdsCsdsStreamingBootstrapFromEnvVar*"
		"XdsTest/ClientStatusDiscoveryServiceTest.XdsConfigDumpClusterRequested/V3BootstrapFromEnvVar*"
		"XdsTest/ClientStatusDiscoveryServiceTest.XdsConfigDumpClusterRequested/V3RdsBootstrapFromEnvVar*"
		"XdsTest/ClientStatusDiscoveryServiceTest.XdsConfigDumpClusterRequested/V3CsdsStreamingBootstrapFromEnvVar*"
		"XdsTest/ClientStatusDiscoveryServiceTest.XdsConfigDumpClusterRequested/V3RdsCsdsStreamingBootstrapFromEnvVar*"
		"XdsTest/ClientStatusDiscoveryServiceTest.XdsConfigDumpMultiClient/V3BootstrapFromEnvVar*"
		"XdsTest/ClientStatusDiscoveryServiceTest.XdsConfigDumpMultiClient/V3RdsBootstrapFromEnvVar*"
		"XdsTest/ClientStatusDiscoveryServiceTest.XdsConfigDumpMultiClient/V3CsdsStreamingBootstrapFromEnvVar*"
		"XdsTest/ClientStatusDiscoveryServiceTest.XdsConfigDumpMultiClient/V3RdsCsdsStreamingBootstrapFromEnvVar*"
		"XdsTest/CsdsShortAdsTimeoutTest.XdsConfigDumpRouteConfigDoesNotExist/V3RdsBootstrapFromEnvVar*"
		"XdsTest/CsdsShortAdsTimeoutTest.XdsConfigDumpRouteConfigDoesNotExist/V3RdsCsdsStreamingBootstrapFromEnvVar*"
		"XdsTest/CsdsShortAdsTimeoutTest.XdsConfigDumpClusterDoesNotExist/V3BootstrapFromEnvVar*"
		"XdsTest/CsdsShortAdsTimeoutTest.XdsConfigDumpClusterDoesNotExist/V3RdsBootstrapFromEnvVar*"
		"XdsTest/CsdsShortAdsTimeoutTest.XdsConfigDumpClusterDoesNotExist/V3CsdsStreamingBootstrapFromEnvVar*"
		"XdsTest/CsdsShortAdsTimeoutTest.XdsConfigDumpClusterDoesNotExist/V3RdsCsdsStreamingBootstrapFromEnvVar*"
		"XdsTest/CsdsShortAdsTimeoutTest.XdsConfigDumpEndpointDoesNotExist/V3BootstrapFromEnvVar*"
		"XdsTest/CsdsShortAdsTimeoutTest.XdsConfigDumpEndpointDoesNotExist/V3RdsBootstrapFromEnvVar*"
		"XdsTest/CsdsShortAdsTimeoutTest.XdsConfigDumpEndpointDoesNotExist/V3CsdsStreamingBootstrapFromEnvVar*"
		"XdsTest/CsdsShortAdsTimeoutTest.XdsConfigDumpEndpointDoesNotExist/V3RdsCsdsStreamingBootstrapFromEnvVar*"
