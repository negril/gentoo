...
PATCHES=(
	...
	# "${FILESDIR}/${PN}-1.65.0-fix-tests.patch"
	"${FILESDIR}/${PN}-1.65.0-ABSL_VLOG_IS_ON.patch"
)
...
src_prepare() {
	...
	# so we have to re-declare them as dependencies of the test binaries individually.
	local extra_libs=(
					"GTest::gtest"
					"GTest::gmock"
					"\${_gRPC_RE2_LIBRARIES}"
