...
if [[ ${PV} == *9999* ]] ; then
	...
	SRC_URI="
		...
		https://github.com/google/libultrahdr/commit/5fa99b5271a3c80a13c78062d7adc6310222dd8e.patch -> ${PN}-PR363.patch
	"
	KEYWORDS="~amd64"
fi
...
PATCHES=(
	...
	"${FILESDIR}/${PN}-1.4.0-static-libs-optional.patch"
	"${DISTDIR}/${PN}-PR363.patch"
)
