...
if [[ ${PV} = *9999* ]] ; then
	...
	SRC_URI="https://github.com/${PN}/${PN}/archive/${PV}.tar.gz -> ${P}.tar.gz
		https://github.com/${PN}/ade/archive/v${ADE_PV}.tar.gz -> ade-${ADE_PV}.tar.gz
		contrib? (
...
src_unpack() {
	if [[ ${PV} = *9999* ]] ; then
		git-r3_checkout
		use contrib && git-r3_fetch "https://github.com/${PN}/${PN}_contrib" "${EGIT_OVERRIDE_BRANCH_OPENCV_OPENCV:-${EGIT_BRANCH}}"
		use contrib && git-r3_checkout "https://github.com/${PN}/${PN}_contrib" "${WORKDIR}/${PN}_contrib-${PV}"
	else
		default
	fi
}
