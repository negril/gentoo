...
if [[ ${PV} == *9999* ]] ; then
	...
	SRC_URI="
		...
		https://github.com/opencv/opencv/commit/54b03cc2f84cfe83222c59b747e17cb378a9744c.patch -> ${PN}-fix_videowriter_raw_return_code.patch
	"
...
# 	"${FILESDIR}/${PN}-4.12.0-link-with-cblas-for-lapack.patch"
	...
	"${DISTDIR}/${PN}-fix_videowriter_raw_return_code.patch"
