...
PATCHES=(
	# "${FILESDIR}/${PN}-6.3.1-cmake-installdirs.patch"
	# "${FILESDIR}/${PN}-6.3.1-cmake-examples-optional.patch"
	"${FILESDIR}/${PN}-6.3.1-cmake-python-optional.patch"
	"${FILESDIR}/${PN}-6.3.1-cmake-spm-project.patch"
	# "${FILESDIR}/${PN}-6.3.1-cmake-min-version.patch"
	"${FILESDIR}/${PN}-6.3.1-cmake-cuda.patch"
	"${FILESDIR}/${PN}-6.3.1-scipy.patch"
)
